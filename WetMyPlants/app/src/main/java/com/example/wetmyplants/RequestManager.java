    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        postButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick (View v){
                StringRequest stringRequest = searchNameStringRequest("/token/");
        ...
        return new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            Toast.makeText(RequestManager.this, expiration + "\n" + secret, Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(RequestManager.this, e.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    } // public void onResponse(String response)
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(RequestManager.this, "Plant source is not responding (OpenFarm API)", Toast.LENGTH_LONG).show();
                    }
                })
                {
